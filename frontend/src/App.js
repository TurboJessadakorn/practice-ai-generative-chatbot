...
function App() {
  ...
  return (
    <div class="flex justify-center w-100% items-center h-screen bg-slate-200">
      ...
      <div class="box-shadow: 0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05); mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px]">
        ...
        {/* Chat Container */}
        <div class="pr-4 h-[474px] min-width: 100%; display: table; overflow-y-auto">
          {/* Chat Message AI */}
